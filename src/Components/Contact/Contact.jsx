  ...
  return (
    <>
      <div className='bg-gray-900 p-10'>
        ...
        {/* form */}
        <form action="" className='justify-center items-center m-2 p-4 flex gap-5 font-semibold text-[15px]'>
          <div className='bg-gray-300 p-5 justify-center items-center flex flex-col rounded-2xl'>
            <div className='flex flex-wrap gap-5'>
              ...
              <div className='flex flex-col gap-6 items-end'>
                ...
                <textarea id="message" className='p-1 text-sm outline-none text-center w-full rounded' placeholder='Enter message'></textarea>
              </div>
            </div>

            <div className='w-full flex justify-center items-center'>
              <button type="submit" className='w-full bg-red-600 hover:outline outline-red-500 text-white rounded-xl m-4 p-2'>Submit</button>
            </div>
          </div>
        </form>
        {/* form end */}
